...
THEMES = {
    ...
    # separate design.
    "light": {
        "bg": "#F6F8F1", "surface": "#FFFFFF", "surface_alt": "#F8F6F3",
    ...
    "dark": {
        ...
        "text": "#F1F5F3", "muted": "#9AA8A3", "accent": "#22E6A7",
...
FONTS = {
    ...
    "body": ("Segoe UI", 10),
    "caption": ("Segoe UI", 10),
    "countdown": ("Consolas", 32, "bold"),
    "countdown_big": ("Consolas", 72, "bold"),
    "mono": ("Consolas", 10),
}
...
class App:
    ...
    def build_ui(self) -> None:
        ...
        sidebar = ttk.Frame(shell, style="Sidebar.TFrame", padding=(28, 32, 28, 20))
        ...
        for key, label in (
            ...
            bar = tk.Frame(container, width=3, background=self.tokens["sidebar"])
        ...
        self.ring_canvas.grid(row=0, column=1, sticky="ns", padx=(36, 12))
