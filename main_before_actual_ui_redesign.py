...
THEMES = {
    ...
    # separate design.
    "light": {
        "bg": "#F6F4F1", "surface": "#FFFFFF", "surface_alt": "#F8F6F3",
        "border": "#D9D3CC", "border_soft": "#E8E2D9",
        "text": "#121B19", "muted": "#5F625C", "accent": "#0E8A75",
        "accent_hover": "#0A6E5F", "accent_text": "#FFFFFF",
        "success": "#128F6A", "warning": "#B9821F", "error": "#C74332",
        "disabled_fg": "#9AA8A3", "disabled_field": "#E8E6E2",
        "focus": "#0E8A75", "hover_field": "#E8F4F1",
        "chip_bg": "#E1F1EA", "hero_bg": "#FFFFFF",
        "sidebar": "#0F1B17", "sidebar_active": "#1B2E27",
        "sidebar_text": "#B7C7C1", "ring_track": "#DEE7E3",
        "countdown_text": "#121B19",
    },
    "dark": {
        "bg": "#0A0B0A", "surface": "#121613", "surface_alt": "#0F1311",
        "border": "#24302B", "border_soft": "#1C2621",
        "text": "#F1F5F3", "muted": "#9AA8A3", "accent": "#1FD0A1",
        "accent_hover": "#2FE1B5", "accent_text": "#031F1A",
        "success": "#3FDB9B", "warning": "#EFB65B", "error": "#F1786C",
        "disabled_fg": "#5C6862", "disabled_field": "#171E1A",
        "focus": "#1FD0A1", "hover_field": "#182420",
        "chip_bg": "#152420", "hero_bg": "#121613",
        "sidebar": "#070807", "sidebar_active": "#141C18",
        "sidebar_text": "#9AA8A3", "ring_track": "#24302B",
...
class App:
    ...
    def build_ui(self) -> None:
        ...
        sidebar = ttk.Frame(shell, style="Sidebar.TFrame", padding=(20, 24, 20, 16))
        ...
        hero_row.grid(row=0, column=0, sticky="nsew", pady=(0, 16))
        ...
        times_dash_outer.grid(row=1, column=0, sticky="nsew", pady=(0, 16))
